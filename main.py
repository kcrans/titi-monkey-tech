...
def main():
    ...
    def write_data(trial_num, stop_stim, screen_touched, response_time, hold_touches, direct_touch, scale):
        dataFile.write(f"{subject_choice},{sub_cond},{timestamp},{chosen_phase},{trial_num},{stop_stim},{screen_touched},{response_time},{hold_touches},{direct_touch},{scale},{session_timeout_time},{pos_shape_name},{neg_shape_name},{param_string}\n")
        return
